...
--11. Fetch data of all matches played in Rajiv Gandhi international stadium uppal.

SELECT * FROM matches
WHERE venue = 'Rajiv Gandhi International Stadium Uppal';

--12. Number of matches won by Chennai super king and Mumbai Indians.
...
--13. No. Of matches played on or before 4/20/2014.
